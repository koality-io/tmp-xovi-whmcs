...
final class KaApi
{
     ...
     * @throws Exception
     */
    public function createLicense(Plan $plan): License
    {
        $options = [
            'json' => [
                'items' => $this->buildItems($plan),
            ],
        ];
     ...
     * @throws Exception
     */
    public function modifyLicense(string $keyId, Plan $plan): License
    {
        $options = [
            'json' => [
                'items' => $this->buildItems($plan),
     ...
     */
    private function buildItems(Plan $plan): array
    {
        return [
            [
